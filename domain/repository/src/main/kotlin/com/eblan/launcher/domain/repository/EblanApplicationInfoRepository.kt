...
interface EblanApplicationInfoRepository {
    ...
    fun getEblanApplicationInfosByTagId(tagId: Long): Flow<List<EblanApplicationInfo>>

    fun getEblanApplicationInfosByTagId(tagIds: List<Long>): List<EblanApplicationInfo>
