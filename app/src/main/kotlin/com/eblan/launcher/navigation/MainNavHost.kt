...
import com.eblan.launcher.feature.editapplicationinfo.navigation.editApplicationInfoScreen
import com.eblan.launcher.feature.editapplicationinfo.navigation.navigateToEditApplicationInfoScreen
...
fun MainNavHost(
    ...
    NavHost(
        ...
        homeScreen(
            ...
            onEditApplicationInfo = navController::navigateToEditApplicationInfoScreen,
        )

        editGridItemScreen(onNavigateUp = navController::navigateUp)

        editApplicationInfoScreen(onNavigateUp = navController::navigateUp)
    }
}
