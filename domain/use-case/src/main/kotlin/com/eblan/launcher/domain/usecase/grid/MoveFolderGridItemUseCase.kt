...
class MoveFolderGridItemUseCase @Inject constructor(
    ...
    suspend operator fun invoke(
        ...
        withContext(defaultDispatcher) {
            ...
            val indexedApplicationInfoGridItems = currentApplicationInfoGridItems.mapIndexed { index, gridItem ->
                ensureActive()
            ...
            val gridItemsByPage = indexedApplicationInfoGridItems.getGridItemsByPage()
            ...
            val newData = folderData.copy(
                gridItems = indexedApplicationInfoGridItems,
