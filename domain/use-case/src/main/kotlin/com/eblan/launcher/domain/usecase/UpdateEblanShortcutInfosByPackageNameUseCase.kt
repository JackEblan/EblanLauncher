...
class UpdateEblanShortcutInfosByPackageNameUseCase @Inject constructor(
    ...
    suspend operator fun invoke(packageName: String) {
        ...
        withContext(ioDispatcher) {
            ...
            val newEblanShortcutInfos =
                launcherAppsWrapper.getShortcuts()?.filter { launcherAppsShortcutInfo ->
                    launcherAppsShortcutInfo.packageName == packageName
                }?.mapNotNull { launcherAppsShortcutInfo ->
