...
interface EblanAppWidgetProviderInfoDao {
    ...
    @Query("SELECT * FROM EblanAppWidgetProviderInfoEntity WHERE serialNumber = :serialNumber AND packageName = :className")
    suspend fun getEblanAppWidgetProviderInfoEntity(
        serialNumber: Long,
        className: String,
